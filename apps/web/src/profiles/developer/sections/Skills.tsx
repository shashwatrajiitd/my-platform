...
export function DeveloperSkills() {
  ...
  const programmingItems = programmingRow.cards.map((card, cardIndex) => {
    ...
    return {
      id: `developer-programming-${cardIndex}-${slug}`,
      title: card.label,
      targetId: `developer-programming-${cardIndex}-${slug}`,
  ...
  const coreAiItems = coreAiRow.cards.map((card, cardIndex) => {
    const slug = card.skill.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')
    return {
      id: `developer-core-ai-${cardIndex}-${slug}`,
      title: card.label,
      targetId: `developer-core-ai-${cardIndex}-${slug}`,
      previewSrc: card.previewSrc ?? '',
      chips: card.tags,
      description: card.lines.join(' • '),
    }
  ...
  const systemsItems = systemsRow.cards.map((card, cardIndex) => {
    const slug = card.skill.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')
    return {
      id: `developer-systems-${cardIndex}-${slug}`,
      title: card.label,
      targetId: `developer-systems-${cardIndex}-${slug}`,
      previewSrc: card.previewSrc ?? '',
      chips: card.tags,
      description: card.lines.join(' • '),
    }
  ...
  return (
    <section id="developer-skills" className="core-skills-section">
      ...
      <div className="skills-row">
        <ContinueWatchingPreview
          ...
          titleId="developer-programming-title"
      ...
      <div className="skills-row">
        <ContinueWatchingPreview
          ...
          titleId="developer-core-ai-title"
      ...
      <div className="skills-row">
        <ContinueWatchingPreview
          ...
          titleId="developer-systems-title"
