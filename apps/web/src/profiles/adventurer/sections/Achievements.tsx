...
export function AdventurerAchievements() {
  const items = [
    {
      ...
      targetId: 'adventurer-achievement-jee',
    ...
    },
    {
      ...
      targetId: 'adventurer-achievement-ntse',
    ...
    },
    {
      ...
      targetId: 'adventurer-achievement-swc',
    ...
    },
    {
      ...
      targetId: 'adventurer-achievement-rmo',
  ...
  return (
    <section id="adventurer-achievements" className="core-skills-section">
      <ContinueWatchingPreview
        title="Achievements"
        titleId="adventurer-achievements-title"
