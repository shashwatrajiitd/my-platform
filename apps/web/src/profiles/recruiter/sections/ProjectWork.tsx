...
export function RecruiterProjectWork() {
  const items = [
    {
      id: 'population-sim',
      title: 'Population Dynamics Simulator',
      targetId: 'recruiter-project-population-sim',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-god-eye',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-content-creator',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-health-assistant',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-transformer-forecasting',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-os-scheduling',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-memory-scheduling',
    ...
    },
    {
      ...
      targetId: 'recruiter-project-dynamic-memory',
  ...
  return (
    <section id="recruiter-projects" className="core-skills-section">
      <ContinueWatchingPreview
        title="Project Work"
        titleId="recruiter-projects-title"
