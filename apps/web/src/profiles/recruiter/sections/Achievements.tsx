  ...
  const items = [
    {
      ...
      targetId: 'recruiter-achievement-jee',
    ...
    },
    {
      ...
      targetId: 'recruiter-achievement-ntse',
    ...
    },
    {
      ...
      targetId: 'recruiter-achievement-swc',
    ...
    },
    {
      ...
      targetId: 'recruiter-achievement-rmo',
  ...
  return (
    <section id="recruiter-achievements" className="core-skills-section">
      <ContinueWatchingPreview
        title="Achievements"
        titleId="recruiter-achievements-title"
